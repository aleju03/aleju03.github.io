...
export const secondary: SecondaryProject[] = [
  {
    ...
    image: '/projects/peeko.svg',
    imageAlt: 'peeko mark, a little head peeking over a dashboard card',
    tile: 'dark',
  ...
  },
  {
    ...
    image: '/projects/kewa.svg',
    imageAlt: 'kewa mark, a take-a-number strip with the front ticket torn off',
    tile: 'dark',
  ...
  },
  {
    ...
    tech: ['TypeScript', 'Node.js', 'SQLite', 'SSE'],
    image: '/projects/replayd.svg',
    imageAlt: 'replayd mark, a cassette with a pencil in the reel',
    tile: 'dark',
  ...
  },
  {
    ...
    image: '/projects/snake-docker.svg',
    imageAlt: 'SnakeDocker mark, a snake made of shipping containers',
    tile: 'dark',
  ...
  },
  {
    ...
    imageAlt: 'DocIndexer mark, a card-catalogue drawer with one card pulled up',
    tile: 'dark',
